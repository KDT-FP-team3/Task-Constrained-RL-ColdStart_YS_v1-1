...
| Member 6 | 로열 골드 | RGLD | 100 | STATIC_H | O | — | **102.12%** | 84.73% | **+17.6%p** |
...
**파라미터**: STATIC_H | 8-State | Trading Days=300 | Train Epi=150 | Seed=42 | lr=0.073 | γ=0.94 | ε=0.13 | v_ε=0.10
...
**파라미터**: STATIC_H | 4-State | Trading Days=500 | Train Epi=300 | Seed=137 | lr=0.080 | γ=0.91 | ε=0.12 | v_ε=0.18
...
**파라미터**: STATIC_H | 8-State | Trading Days=500 | Train Epi=300 | Seed=2024 | lr=0.050 | γ=0.88 | ε=0.02 | v_ε=0.16
...
**파라미터**: STATIC_H | 8-State | Roll=30봉 | Trading Days=500 | Train Epi=300 | Seed=777 | lr=0.038 | γ=0.92 | ε=0.08 | v_ε=0.06
...
**파라미터**: STATIC_H | 8-State | Roll=60봉 | Trading Days=500 | Train Epi=300 | Seed=314 | lr=0.026 | γ=0.92 | ε=0.04 | v_ε=0.11
...
**파라미터**: STATIC_H | 8-State | Trading Days=300 | Train Epi=150 | Seed=100 | lr=0.022 | γ=0.95 | ε=0.16 | v_ε=0.14
