...
### 6. SAC (Soft Actor-Critic) — 탐험 자동 조절
...
4단계: SAC                     epsilon 무관한 자동 탐험 조절 확인
5단계: A3C vs A2C              동일 종목에서 n-step vs 1-step 차이 비교
6단계: DDPG                    연속 포지션 개념, Trading Days 충분히 확보 후 실행
```
